...
In this chapter, \ce{Pt} and \ce{Au} (557) surfaces exposed to various
coverages of \ce{CO} are simulated. The effect of \ce{CO}-\ce{CO} repulsion is
examined as a possible cause for experimentally observed step-doubling of the
\ce{Pt} (557) system. Additionally, the strong \ce{Pt\bond{-}CO} bond is also
believed to play a role, whereas the \ce{Au\bond{-}CO} interaction is
significantly weaker suggesting less possible reconstruction on the \ce{Au}
...
melting,\citep{Belonoshko00, Sankaranarayanan:2006ye, Sankaranarayanan:2005bh}
