...
An expanded version of Figure \ref{fig:domainAreasPd} in the main text which contains data
...
An expanded version of Figure \ref{fig:domainAreasPt} in the main text which contains data
for all five \ce{CO} coverage levels.
...
\begin{figure}
  ...
  \caption{Distribution of small \ce{Pt} domain sizes at different
    ...
    Figure \ref{fig:domainAreasPt} in the main text.}
...
An expanded version of Figure \ref{fig:nearestNeighbors} in the main text which contains data
