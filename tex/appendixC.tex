...
\caption{Observed inversion events on the 111-1\ce{Pt}-1\ce{Pt} surface with a
0.5 ML coverage of \ce{CO}. The left image (a) is after one nanosecond of data
collection while the right image (b) is taken at the end of six nanoseconds.
Pink atoms on the surface are \ce{Pd} atoms that have undergone an inversion
event with the surface \ce{Pt}.}
\label{fig:inversion}
\end{figure}
