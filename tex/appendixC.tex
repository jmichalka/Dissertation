...
that with this potential, the \ce{Pd\bond{-}CO} binding interaction is 0.2
eV more favorable than the \ce{Pt\bond{-}CO} interaction. Additionally,
...
was composed of the higher melting metal (\ce{Rh}) there was an imposed
stability on the confined inner metal (\ce{Pt}). For our systems, \ce{Pt} ($T_m
