...
\title{ADSORBATE INDUCED RECONSTRUCTIONS ON METAL SURFACES}            % TITLE OF WORK. It must be in all caps, and ensuring this is your
 % responsiblity.
...
restructuring of Platinum stepped surfaces. Additionally, I am presenting work
on the development of a multiple-minima fluctuating charge (MM-flucq)
electrostatic interaction potential which has been use to simulate oxide
