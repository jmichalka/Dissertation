...
$(\sqrt{3}\times\sqrt{3})\textrm{R}30^o$ at $\theta=1/3$, (b) c$(4\times2)$ at $\theta=1/2$, (c) $(2\times2)$ at $\theta=3/4$.}
\label{fig:patterns}
\end{figure}
...
transfer and bond formations and breakages throughout the reactions.
...
In contrast to Density Functional Theory and other methods that attempt to
solve the electronic wave functions within a molecular system, most
implementations of molecular dynamics sacrifice this portion of the molecular
description in order to gain the ability to model larger systems ($>$1e3
...
given temperature or pressure and while important, go beyond our brief introduction
to molecular dynamics, but further resources can be found in References
\citep{Hoover:1985aa, Melchionna:1993aa, Leach:2001aa}.

While all of the above mentioned steps are necessary, number 4, the calculation
of forces is potentially the most important as it deals with all of the
interactions in the system. As the forces are obtained by taking the derivative
of the interaction potential with respect to position, a brief overview of
...
other along a vector $r$. The Lennard Jones potential is parameterized by two variables, $\sigma$,
...
distance and, $\gamma$, a knob with which to tune the curvature of the attractive well.
